...
from models.encoders.vmamba6 import Backbone_VSSM, CrossMambaFusionBlock, ConcatMambaFusionBlock
...
class vssm_small(RGBXTransformer):
    def __init__(self, fuse_cfg=None, **kwargs):
        super(vssm_small, self).__init__(
            depths=[2, 2, 27, 2],
            dims=96,
            pretrained='/home/cver2080/4TDISK/jyn/Projects/FEMamba/pretrained/vmamba/vssmsmall_dp03_ckpt_epoch_238.pth',
            mlp_ratio=0.0,
            downsample_version='v1',
            drop_path_rate=0.3,
        )
