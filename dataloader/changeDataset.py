...
class ChangeDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        gt_path = os.path.join(self._root_path, 'label', item_name + self._gt_format)
    ...
    def _get_file_names(self, split_name):
        ...
        source = os.path.join(self._root_path, 'list/' + split_name +'.txt')
...
if __name__=='__main__':
    data_setting = {'root': '/home/cver2080/Public/Datasets/LEVIR-CD',
                    'A_format': '.png',
                    'B_format': '.png',
                    'gt_format': '.png',
